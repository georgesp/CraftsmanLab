# Guide et Règles ASP.NET Core pour CraftsmanLab

Ce document regroupe les règles obligatoires et les meilleures pratiques pour le développement d'applications ASP.NET Core dans le projet CraftsmanLab. Il s'appuie sur l'[AspNetCore Guidance](https://github.com/davidfowl/AspNetCoreDiagnosticScenarios/blob/master/AspNetCoreGuidance.md) et adapte les recommandations au contexte du workspace.

## Objectif
- Garantir la qualité, la sécurité et la maintenabilité du code ASP.NET Core
- Faciliter la compréhension et l’application des conventions CraftsmanLab
