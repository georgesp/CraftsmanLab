...
const CSharp12Tip: React.FC = () => {
  ...
  return (
    <TipContent>
      ...
      <Box component="ul" sx={{ pl: 3, mb: 2 }}>
        {(t('csharp-12.content.features.items', { returnObjects: true }) as string[]).map((txt, i) => {
          const anchors = ['primary-constructors', 'collection-expressions', 'lambda-defaults', 'type-alias', 'inline-array', 'patterns'];
      ...
      <Typography id="primary-constructors" variant="h5">{t('csharp-12.content.useCases.case1.title')}</Typography>
      ...
      <Typography id="collection-expressions" variant="h5">{t('csharp-12.content.useCases.case2.title')}</Typography>
      ...
      <Typography id="lambda-defaults" variant="h5">{t('csharp-12.content.useCases.case3.title')}</Typography>
      ...
      <Typography id="type-alias" variant="h5">{t('csharp-12.content.extras.typeAlias.title')}</Typography>
      <Typography paragraph>{t('csharp-12.content.extras.typeAlias.description')}</Typography>
      <CodeBlock language="csharp" ariaLabel="csharp12-type-alias" code={t('csharp-12.content.extras.typeAlias.code')} />
      <Typography id="inline-array" variant="h5">{t('csharp-12.content.extras.inlineArray.title')}</Typography>
      <Typography paragraph>{t('csharp-12.content.extras.inlineArray.description')}</Typography>
      <CodeBlock language="csharp" ariaLabel="csharp12-inline-array" code={t('csharp-12.content.extras.inlineArray.code')} />
      <Typography id="patterns" variant="h5">{t('csharp-12.content.extras.patterns.title')}</Typography>
      <Typography paragraph>{t('csharp-12.content.extras.patterns.description')}</Typography>
      <CodeBlock language="csharp" ariaLabel="csharp12-patterns" code={t('csharp-12.content.extras.patterns.code')} />
