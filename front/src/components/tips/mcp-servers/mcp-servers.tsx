...
const McpServersTip: React.FC = () => {
  ...
  return (
    <TipContent>
      ...
      <Box component="ul">
        {(t('mcp-servers.content.config.steps', { returnObjects: true }) as string[]).map(
          (x, i) => (
            <li key={i}>
      ...
      <Box component="ul">
        {(t('mcp-servers.content.github.useCases', { returnObjects: true }) as string[]).map(
          (x, i) => (
            <li key={i}>
              <Typography component="span">{x}</Typography>
            </li>
      ...
      <CodeBlock
        language="bash"
        ariaLabel="mcp-github-examples"
        code={t('mcp-servers.content.github.codeExamples')}
      />
      ...
      <Box component="ul">
        {(t('mcp-servers.content.msdocs.useCases', { returnObjects: true }) as string[]).map(
          (x, i) => (
            <li key={i}>
              <Typography component="span">{x}</Typography>
            </li>
      ...
      <CodeBlock
        language="bash"
        ariaLabel="mcp-msdocs-examples"
        code={t('mcp-servers.content.msdocs.codeExamples')}
      />
      ...
      <Box component="ul">
        {(t('mcp-servers.content.figma.useCases', { returnObjects: true }) as string[]).map(
          (x, i) => (
            <li key={i}>
              <Typography component="span">{x}</Typography>
            </li>
      ...
      <CodeBlock
        language="bash"
        ariaLabel="mcp-figma-examples"
        code={t('mcp-servers.content.figma.codeExamples')}
      />
      ...
      <Box component="ul">
        {(t('mcp-servers.content.azureDevOps.useCases', { returnObjects: true }) as string[]).map(
          (x, i) => (
            <li key={i}>
              <Typography component="span">{x}</Typography>
            </li>
      ...
      <CodeBlock
        language="bash"
        ariaLabel="mcp-azdo-examples"
        code={t('mcp-servers.content.azureDevOps.codeExamples')}
      />
      ...
      >
        <Typography variant="caption" sx={{ fontStyle: 'italic' }}>
          <a
            href="https://code.visualstudio.com/mcp"
            target="_blank"
