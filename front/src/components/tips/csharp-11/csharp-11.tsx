...
const CSharp11Tip: React.FC = () => {
  ...
  return (
    <TipContent>
      ...
      <Box component="ul" sx={{ pl: 3, mb: 2 }}>
        {(t('csharp-11.content.features.items', { returnObjects: true }) as string[]).map(
          (txt, i) => {
            const anchors = [
              'raw-strings',
              'required-members',
      ...
      <Typography id="raw-strings" variant="h5">
        {t('csharp-11.content.useCases.case1.title')}
      </Typography>
      <Typography paragraph>{t('csharp-11.content.useCases.case1.description')}</Typography>
      <CodeBlock
        language="csharp"
        ariaLabel="csharp11-raw-strings"
        code={t('csharp-11.content.useCases.case1.code')}
      />

      <Typography id="required-members" variant="h5">
        {t('csharp-11.content.useCases.case2.title')}
      </Typography>
      <Typography paragraph>{t('csharp-11.content.useCases.case2.description')}</Typography>
      <CodeBlock
        language="csharp"
        ariaLabel="csharp11-required"
        code={t('csharp-11.content.useCases.case2.code')}
      />

      <Typography id="list-patterns" variant="h5">
        {t('csharp-11.content.useCases.case3.title')}
      </Typography>
      <Typography paragraph>{t('csharp-11.content.useCases.case3.description')}</Typography>
      <CodeBlock
        language="csharp"
        ariaLabel="csharp11-list-patterns"
        code={t('csharp-11.content.useCases.case3.code')}
      />

      <Typography variant="h4">{t('csharp-11.content.extras.title')}</Typography>
      <Typography id="generic-math" variant="h5">
        {t('csharp-11.content.extras.genericMath.title')}
      </Typography>
      <Typography paragraph>{t('csharp-11.content.extras.genericMath.description')}</Typography>
      <CodeBlock
        language="csharp"
        ariaLabel="csharp11-generic-math"
        code={t('csharp-11.content.extras.genericMath.code')}
      />
      <Typography id="utf8-literals" variant="h5">
        {t('csharp-11.content.extras.utf8.title')}
      </Typography>
      <Typography paragraph>{t('csharp-11.content.extras.utf8.description')}</Typography>
      <CodeBlock
        language="csharp"
        ariaLabel="csharp11-utf8"
        code={t('csharp-11.content.extras.utf8.code')}
      />
      <Typography id="file-scoped-types" variant="h5">
        {t('csharp-11.content.extras.fileScopedTypes.title')}
      </Typography>
      <Typography paragraph>{t('csharp-11.content.extras.fileScopedTypes.description')}</Typography>
      <CodeBlock
        language="csharp"
        ariaLabel="csharp11-file-scoped"
        code={t('csharp-11.content.extras.fileScopedTypes.code')}
      />
      ...
      >
        <Typography variant="caption" sx={{ fontStyle: 'italic' }}>
          ...
          {(
            t('csharp-11.content.footer.sources', { returnObjects: true }) as {
              name: string;
              url: string;
            }[]
          ).map((s, i) => (
            <span key={i}>
              ...
              {i <
              (t('csharp-11.content.footer.sources', { returnObjects: true }) as any[]).length - 1
                ? ' • '
                : ''}
            </span>
          ))}
