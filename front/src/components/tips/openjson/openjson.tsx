  ...
  return (
    <TipContent>
      ...
      <Typography variant="subtitle1" gutterBottom>
        {t('openjson.content.useCases.case1.inputTitle')}
      </Typography>
      <CodeBlock
        language="sql"
        ariaLabel="openjson-case1-input"
        code={`-- Sample data
DECLARE @payload NVARCHAR(MAX) = N'{"id":1,"name":"Alice","tags":["vip","tech"]}';`}
      ...
      <CodeBlock
        ...
        code={`-- Project properties using WITH mapping and paths
SELECT
  J.Id,
  J.Name
...
1   Alice`}
      ...
      <Typography variant="subtitle1" gutterBottom>
        {t('openjson.content.useCases.case2.inputTitle')}
      </Typography>
      <CodeBlock
        language="sql"
        ariaLabel="openjson-case2-input"
        code={`-- Sample data
DECLARE @payload NVARCHAR(MAX) = N'{"items":[{"sku":"KB","qty":1},{"sku":"MS","qty":3}]}';`}
      ...
      <CodeBlock
        ...
        code={`-- Read array elements with CROSS APPLY
SELECT
...
1          {"sku":"MS","qty":3}                     MS   3`}
      ...
      <Typography variant="subtitle1" gutterBottom>
        {t('openjson.content.useCases.case3.inputTitle')}
      </Typography>
      <CodeBlock
        language="sql"
