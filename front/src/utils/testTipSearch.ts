...
// Usage: node testTipSearch.ts (dans le dossier front)
...
function searchTips(tips: any[], query: string, language: 'fr' | 'en' = 'fr') {
  ...
  return tips.filter(tip => {
    ...
    if (tip.keywords.some((keyword: string) => 
...
// Tests de recherche
console.log('🔍 Tests de recherche des Tips\n');

const testCases = [
  // Tests en français
  { query: 'base de données', lang: 'fr' as const, expected: ['dapper'] },
  { query: 'transformation', lang: 'fr' as const, expected: ['automapper'] },
  { query: 'tests', lang: 'fr' as const, expected: ['xunit', 'nsubstitute'] },
  { query: 'mock', lang: 'fr' as const, expected: ['nsubstitute'] },
  { query: 'polly', lang: 'fr' as const, expected: ['polly'] },
  { query: 'collections', lang: 'fr' as const, expected: ['collection'] },
  { query: 'facet', lang: 'fr' as const, expected: ['facet'] },
  
  // Tests en anglais
  { query: 'database', lang: 'en' as const, expected: ['dapper'] },
  { query: 'mapping', lang: 'en' as const, expected: ['dapper', 'automapper', 'facet'] },
  { query: 'testing', lang: 'en' as const, expected: ['xunit'] },
  { query: 'resilience', lang: 'en' as const, expected: ['polly'] },
  { query: 'generator', lang: 'en' as const, expected: ['facet'] },
  
  // Tests par titre/description
  { query: 'dapper', lang: 'fr' as const, expected: ['dapper'] },
  { query: 'fixtures', lang: 'fr' as const, expected: ['xunit'] },
  { query: 'ef core', lang: 'fr' as const, expected: ['facet'] },
  
  // Tests vides
  { query: '', lang: 'fr' as const, expected: mockTips.map(t => t.slug) },
  { query: '   ', lang: 'fr' as const, expected: mockTips.map(t => t.slug) }
];
