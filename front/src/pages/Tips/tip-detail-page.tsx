...
export const TipDetailPage: React.FC = () => {
  ...
  let leftAvailable = vpH - topOffset - PAPER_PADDING_V_PX - titleH - VIEW_ALL_BTN_HEIGHT_PX - VIEW_ALL_BTN_MARGIN_TOP_PX - SAFETY_PX;
  ...
  let rightAvailable = vpH - rightTopOffset - PAPER_PADDING_V_PX - rightTitleH - dividerVSpace - SAFETY_PX;
